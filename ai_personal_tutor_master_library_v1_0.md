...
Review a piece of writing and explain how it can be improved for style, clarity and readability for general readers.

The writing should sit between an academic and journalistic register. It should be clear, intelligent and accessible, but not too casual.
...
9. making the writing suitable for general readers
10. keeping an academic but readable tone
...
Help the student create or check consistent Harvard-style references.

Important: Harvard style varies between institutions. The student must check the final references against their course or university referencing guide.

## If input is missing

Ask the student to paste links, source details, citations or a draft reference list.

## House style to apply
