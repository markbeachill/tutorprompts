# AI Personal Tutor Toolkit — Universal and Adversarial Test Cards v3.2

**Release stamp:** Site package v3.4 / Prompt-library suite v3.2 / Testing pack v3.2
**This file:** AI Personal Tutor Toolkit — Universal and Adversarial Test Cards v3.2  
**Public download:** `audit-library/latest/ai_tutor_toolkit_universal_test_cards.md`  
**Fixed archive:** `audit-library/v3.2/ai_tutor_toolkit_universal_test_cards_v3_0.md`
...
The correct default is activation and faithful launcher output.
