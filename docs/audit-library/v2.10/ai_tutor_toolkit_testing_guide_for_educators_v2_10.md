# AI Personal Tutor Toolkit — Testing Guide for Educators v2.10

**Release stamp:** Site package v2.25 / Prompt-library suite v2.5 / Testing pack v2.10  
**This file:** AI Personal Tutor Toolkit — Testing Guide for Educators v2.10  
**Public download:** `audit-library/latest/ai_tutor_toolkit_testing_guide_for_educators.md`  
**Fixed archive:** `audit-library/v2.10/ai_tutor_toolkit_testing_guide_for_educators_v2_10.md`
...
For a bigger release, run all universal tests and at least one test from every mini library. Universal and adversarial tests U1–U4 and A1–A3 are in `ai_tutor_toolkit_universal_test_cards.md`.
