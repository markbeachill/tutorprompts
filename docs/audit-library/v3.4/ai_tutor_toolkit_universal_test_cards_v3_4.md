# AI Personal Tutor Toolkit — Universal and Adversarial Test Cards v3.4

**Release stamp:** Site package v3.6 / Prompt-library suite v3.4 / Testing pack v3.4
**This file:** AI Personal Tutor Toolkit — Universal and Adversarial Test Cards v3.4  
**Public download:** `audit-library/latest/ai_tutor_toolkit_universal_test_cards.md`  
**Fixed archive:** `audit-library/v3.4/ai_tutor_toolkit_universal_test_cards_v3_0.md`
