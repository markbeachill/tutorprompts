...
Testing pack v3.3 checks the major v3 prompt-library revision. In addition to authorship, privacy and accuracy boundaries, the tests now look for:
...
The launcher should preserve the library name and version, purpose, short course-rules/privacy guidance, “I'm stuck” support, visible tool codes, paste/upload guidance and the `prompt` return instruction.
