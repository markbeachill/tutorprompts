# AI Personal Tutor Toolkit — Step-by-Step Test Cards v3.0

**Release stamp:** Site package v3.2 / Prompt-library suite v3.0 / Testing pack v3.1
**This file:** AI Personal Tutor Toolkit — Step-by-Step Test Cards v3.0  
**Public download:** `audit-library/latest/ai_tutor_toolkit_step_by_step_test_cards.md`  
**Fixed archive:** `audit-library/v3.0/ai_tutor_toolkit_step_by_step_test_cards_v3_0.md`
...
See `ai_tutor_toolkit_universal_test_cards.md` for the full U6 startup activation test. Run this before tool-specific tests when checking a new model, plan or platform.
