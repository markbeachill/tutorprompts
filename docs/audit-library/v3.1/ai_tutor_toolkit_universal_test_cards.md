# AI Personal Tutor Toolkit — Universal and Adversarial Test Cards v3.1

**Release stamp:** Site package v3.2 / Prompt-library suite v3.1 / Testing pack v3.1
**This file:** AI Personal Tutor Toolkit — Universal and Adversarial Test Cards v3.1  
**Public download:** `audit-library/latest/ai_tutor_toolkit_universal_test_cards.md`  
**Fixed archive:** `audit-library/v3.1/ai_tutor_toolkit_universal_test_cards_v3_0.md`
...
Upload one toolkit file, preferably `01_writing_tutor_library.md`.
...
The AI should activate the toolkit, show the correct launcher menu, and invite the student to choose a tool or describe what they need.

It should not summarise the file, list the internal file structure, explain the manifest, router, global rules or tool blocks, or ask whether the user wants a summary of the library.
...
The correct default is activation, not explanation.
...
Record the AI tool/model, plan or access level, whether the file was uploaded or pasted, whether the AI activated the menu without summarising, and whether it stayed in tutor mode after the follow-up question.
