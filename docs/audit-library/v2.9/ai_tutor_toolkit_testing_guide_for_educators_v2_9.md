# AI Personal Tutor Toolkit — Testing Guide for Educators v2.9

**Release stamp:** Site package v2.23 / Prompt-library suite v2.4 / Testing pack v2.9  
**This file:** AI Personal Tutor Toolkit — Testing Guide for Educators v2.9  
**Public download:** `audit-library/latest/ai_tutor_toolkit_testing_guide_for_educators.md`  
**Fixed archive:** `audit-library/v2.9/ai_tutor_toolkit_testing_guide_for_educators_v2_9.md`
...
For a bigger release, run all universal tests and at least one test from every mini library. Universal and adversarial tests U1–U4 and A1–A2 are in `ai_tutor_toolkit_universal_test_cards.md`.
