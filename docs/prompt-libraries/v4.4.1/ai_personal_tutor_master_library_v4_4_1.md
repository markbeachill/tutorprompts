...
**Release stamp:** Toolkit version v4.4.1 / Prompt-library suite v4.4.1 / Testing pack v4.4.1  **This file:** AI Personal Tutor Master Prompt Library v4.4.1  
...
**Fixed archive:** `prompt-libraries/v4.4.1/ai_personal_tutor_master_library_v4_4_1.md`
...
# WT1 — Which Writing Tool Should I Use? v4.4.1
Apply `global-rules`.
...
# WT5 — Teach Me This Mistake v4.4.1
## Purpose
...
# WT5 — Teach Me This Mistake: [specific mistake type or sub-skill] v4.4.1
...
# WT6 — Style and Clarity Review v4.4.1
## Purpose
...
# WT8 — Paraphrase and Quotation Workshop v4.4.1
Apply `global-rules`.
...
# WT9 — Flow and Coherence: The Running Subject v4.4.1
Apply `global-rules`.
...
# WT10 — Learn Subjects: Parsing Your Own Sentences v4.4.1
Apply `global-rules`.
...
# ST1 — Paragraph Structure Review Across a Whole Draft v4.4.1
## Purpose
...
# ST2 — Whole-Work Structure Review v4.4.1
## Purpose
...
# ST4 — Reverse Outline Mapper v4.4.1
## Purpose
...
# RP1 — Research Question, Aim and Objectives Checker v4.4.1
## Purpose
...
# RP2 — Methodology Fit Checker v4.4.1
## Purpose
...
# RP3 — Critical Research Supervisor Review v4.4.1
## Purpose
...
# RP4 — Viva or Supervisor Practice v4.4.1
## Purpose
...
# RP5 — Guided Topic Brainstorming v4.4.1
## Purpose
