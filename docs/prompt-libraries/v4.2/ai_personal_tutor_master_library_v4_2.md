...
**Release stamp:** Toolkit version v4.2 / Prompt-library suite v4.2 / Testing pack v4.2  **This file:** AI Personal Tutor Master Prompt Library v4.2  
...
**Fixed archive:** `prompt-libraries/v4.2/ai_personal_tutor_master_library_v4_2.md`
...
| 4 | WT4 | find-mistakes | Find My Mistakes | identify grammar, logic, clarity, factual, spelling, punctuation and referencing problems |
...
# AI Personal Tutor Toolkit v4.2
...
4. **WT4 — Find My Mistakes** — list and explain mistakes in grammar, logic and clarity.
...
# WT10 — Learn Subjects: Parsing Your Own Sentences v4.2
Apply `global-rules`.
