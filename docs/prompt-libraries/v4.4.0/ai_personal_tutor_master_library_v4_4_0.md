...
**Release stamp:** Toolkit version v4.4.0 / Prompt-library suite v4.4.0 / Testing pack v4.4.0  **This file:** AI Personal Tutor Master Prompt Library v4.4.0  
...
**Fixed archive:** `prompt-libraries/v4.4.0/ai_personal_tutor_master_library_v4_4_0.md`
...
Other options: `not sure`, `list tools`, `EAL on`, `EAL off`, `prompt`.

Please follow your course rules on AI use. Do not upload anything private or personal about other people.
...
# WT1 — Which Writing Tool Should I Use? v4.4.0
Apply `global-rules`.
...
# WT9 — Flow and Coherence: The Running Subject v4.4.0
Apply `global-rules`.
...
# WT10 — Learn Subjects: Parsing Your Own Sentences v4.4.0
Apply `global-rules`.
...
# ST1 — Paragraph Structure Review Across a Whole Draft v4.4.0
## Purpose
...
# ST2 — Whole-Work Structure Review v4.4.0
## Purpose
...
# ST4 — Reverse Outline Mapper v4.4.0
## Purpose
...
# AT1 — Assignment Brief Checker v4.4.0
## Purpose
...
# AT3 — Descriptive vs Analytical Check v4.4.0
## Purpose
...
# AT4 — Evidence Gap Checker v4.4.0
## Purpose
...
# AT5 — Concept Clarity Checker v4.4.0
## Purpose
...
# AT6 — Literature Use Checker v4.4.0
## Purpose
...
# AT9 — Critical Opponent Review v4.4.0
...
# RP1 — Research Question, Aim and Objectives Checker v4.4.0
## Purpose
...
# RP2 — Methodology Fit Checker v4.4.0
## Purpose
...
# RP3 — Critical Research Supervisor Review v4.4.0
## Purpose
...
# RP4 — Viva or Supervisor Practice v4.4.0
## Purpose
...
# RP5 — Guided Topic Brainstorming v4.4.0
## Purpose
...
# SW2 — Tutor Feedback to Action Plan v4.4.0
## Purpose
