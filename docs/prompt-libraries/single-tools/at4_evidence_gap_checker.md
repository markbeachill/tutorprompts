...
|---:|---|---|---|---|
| 1 | AT4 | evidence-gap-checker | Evidence Gap Checker | identify claims that need evidence |
<!-- END FILE -->
...
1. **AT4 — Evidence Gap Checker** — identify claims that need evidence.
<!-- END FILE -->
...
**Argument, evidence and academic thinking tools**
- `1`, `AT4` or `Evidence Gap Checker` → run `evidence-gap-checker`
