...
|---:|---|---|---|---|
| 1 | AT10 | socratic-tutor | Socratic Tutor | discuss a topic through one-question-at-a-time questioning |
<!-- END FILE -->
...
1. **AT10 — Socratic Tutor** — discuss a topic through one-question-at-a-time questioning.
...
**Argument, evidence and academic thinking tools**
- `1`, `AT10` or `Socratic Tutor` → run `socratic-tutor`
