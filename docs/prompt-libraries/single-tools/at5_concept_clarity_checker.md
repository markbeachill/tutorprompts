...
|---:|---|---|---|---|
| 1 | AT5 | concept-clarity-checker | Concept Clarity Checker | check whether key concepts are defined and used clearly |
<!-- END FILE -->
...
1. **AT5 — Concept Clarity Checker** — check whether key concepts are defined and used clearly.
...
**Argument, evidence and academic thinking tools**
- `1`, `AT5` or `Concept Clarity Checker` → run `concept-clarity-checker`
