...
|---:|---|---|---|---|
| 1 | AT8 | source-reliability-checker | Source Reliability Checker | check whether sources look credible, relevant and suitable |
<!-- END FILE -->
...
1. **AT8 — Source Reliability Checker** — check whether sources look credible, relevant and suitable.
...
**Argument, evidence and academic thinking tools**
- `1`, `AT8` or `Source Reliability Checker` → run `source-reliability-checker`
