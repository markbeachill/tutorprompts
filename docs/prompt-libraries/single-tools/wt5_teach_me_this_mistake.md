...
|---:|---|---|---|---|
| 1 | WT5 | teach-mistake | Teach Me This Mistake | learn from a WT4 mistake through an interactive micro-lesson or build copy-ready tutor lesson material |
<!-- END FILE -->
...
1. **WT5 — Teach Me This Mistake** — teach a mistake pattern interactively or build a copy-ready lesson from WT4 feedback.
<!-- END FILE -->
...
**Writing and referencing tools**
- `1`, `WT5` or `Teach Me This Mistake` → run `teach-mistake`
