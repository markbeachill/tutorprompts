...
|---:|---|---|---|---|
| 1 | RP4 | viva-practice | Viva or Supervisor Practice | ask supervisor-style questions one at a time |
<!-- END FILE -->
...
1. **RP4 — Viva or Supervisor Practice** — ask supervisor-style questions one at a time.
<!-- END FILE -->
...
**Research proposal and dissertation tools**
- `1`, `RP4` or `Viva or Supervisor Practice` → run `viva-practice`
