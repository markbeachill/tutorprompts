...
|---:|---|---|---|---|
| 1 | ST3 | expert-meaning-review | Expert Meaning Review | check whether the ideas and interpretations make sense |
<!-- END FILE -->
...
1. **ST3 — Expert Meaning Review** — check whether the ideas and interpretations make sense.
...
**Structure tools**
- `1`, `ST3` or `Expert Meaning Review` → run `expert-meaning-review`
