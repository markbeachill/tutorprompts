...
|---:|---|---|---|---|
| 1 | AT6 | literature-use-checker | Literature Use Checker | review how sources are used |
<!-- END FILE -->
...
1. **AT6 — Literature Use Checker** — review how sources are used.
<!-- END FILE -->
...
**Argument, evidence and academic thinking tools**
- `1`, `AT6` or `Literature Use Checker` → run `literature-use-checker`
