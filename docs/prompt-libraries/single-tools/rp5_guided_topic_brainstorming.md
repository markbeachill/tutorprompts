...
|---:|---|---|---|---|
| 1 | RP5 | topic-brainstorming | Guided Topic Brainstorming | develop possible research topics |
<!-- END FILE -->
...
1. **RP5 — Guided Topic Brainstorming** — develop possible research topics.
<!-- END FILE -->
...
**Research proposal and dissertation tools**
- `1`, `RP5` or `Guided Topic Brainstorming` → run `topic-brainstorming`
