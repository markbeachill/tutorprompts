...
|---:|---|---|---|---|
| 1 | SW2 | feedback-to-action-plan | Tutor Feedback to Action Plan | convert tutor feedback into practical actions |
<!-- END FILE -->
...
1. **SW2 — Tutor Feedback to Action Plan** — convert human tutor feedback into practical actions.
<!-- END FILE -->
...
**Study workflow, revision and integrity tools**
- `1`, `SW2` or `Tutor Feedback to Action Plan` → run `feedback-to-action-plan`
