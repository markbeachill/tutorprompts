...
|---:|---|---|---|---|
| 1 | RP2 | methodology-fit-checker | Methodology Fit Checker | check whether the method fits the research question |
<!-- END FILE -->
...
1. **RP2 — Methodology Fit Checker** — check whether the method fits the research question.
...
**Research proposal and dissertation tools**
- `1`, `RP2` or `Methodology Fit Checker` → run `methodology-fit-checker`
