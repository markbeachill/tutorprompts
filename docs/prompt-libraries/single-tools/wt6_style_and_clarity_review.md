...
|---:|---|---|---|---|
| 1 | WT6 | style-clarity-review | Style and Clarity Review | improve readability, tone and style without rewriting the assignment |
<!-- END FILE -->
...
1. **WT6 — Style and Clarity Review** — show how to improve readability, tone and style without rewriting your assignment.
<!-- END FILE -->
...
**Writing and referencing tools**
- `1`, `WT6` or `Style and Clarity Review` → run `style-clarity-review`
