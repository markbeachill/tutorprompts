...
|---:|---|---|---|---|
| 1 | WT4 | find-mistakes | Find My Mistakes | identify grammar, logic, clarity, factual, spelling, punctuation and referencing problems |
<!-- END FILE -->
...
1. **WT4 — Find My Mistakes** — list and explain mistakes in grammar, logic and clarity.
