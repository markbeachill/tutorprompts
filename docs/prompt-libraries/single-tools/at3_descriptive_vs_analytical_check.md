...
|---:|---|---|---|---|
| 1 | AT3 | descriptive-analytical-check | Descriptive vs Analytical Check | check whether the writing is descriptive or analytical |
<!-- END FILE -->
...
1. **AT3 — Descriptive vs Analytical Check** — check whether the writing is descriptive or analytical.
<!-- END FILE -->
...
**Argument, evidence and academic thinking tools**
- `1`, `AT3` or `Descriptive vs Analytical Check` → run `descriptive-analytical-check`
