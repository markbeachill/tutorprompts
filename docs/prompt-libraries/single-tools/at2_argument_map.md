...
|---:|---|---|---|---|
| 1 | AT2 | argument-map | Argument Map | identify claim, supporting points, evidence, assumptions and gaps |
<!-- END FILE -->
...
1. **AT2 — Argument Map** — identify the claim, supporting points, evidence, assumptions and gaps.
<!-- END FILE -->
...
**Argument, evidence and academic thinking tools**
- `1`, `AT2` or `Argument Map` → run `argument-map`
