...
When the user types `prompt`, output the launcher menu exactly as written. Do not convert it into a table, add emojis, add a welcome line, add a preamble, or rewrite the tool descriptions.
...
**Release stamp:** Site package v3.4 / Prompt-library suite v3.2 / Testing pack v3.2  
**This file:** AI Personal Tutor Master Prompt Library v3.2  
**Public download:** `prompt-libraries/latest/ai_personal_tutor_master_library.md`  
**Fixed archive:** `prompt-libraries/v3.2/ai_personal_tutor_master_library_v3_2.md`
...
4. **WT4 — Teach Me This Mistake** — teach a WT3 mistake pattern interactively or build a copy-ready tutor lesson.
...
Try rewriting the sentence yourself using the principle above. Paste your version here and I will review it. If you're not ready to do that, ask for more options.
...
# WT2 — Single Paragraph Analysis v3.2
...
# WT4 — Teach Me This Mistake v3.2
...
# WT5 — Style and Clarity Review v3.2
...
# ST1 — Paragraph Structure Review Across a Whole Draft v3.2
...
# ST2 — Whole-Work Structure Review v3.2
...
# ST3 — Expert Meaning Review v3.2
...
# AT1 — Assignment Brief Checker v3.2
...
# AT3 — Descriptive vs Analytical Check v3.2
...
# AT5 — Concept Clarity Checker v3.2
...
# AT6 — Literature Use Checker v3.2
...
# AT7 — Counterargument and Limitations Checker v3.2
...
# AT8 — Source Reliability Checker v3.2
...
# AT9 — Critical Opponent Review v3.2
...
# RP1 — Research Question, Aim and Objectives Checker v3.2
...
# RP2 — Methodology Fit Checker v3.2
...
# RP3 — Critical Research Supervisor Review v3.2
...
# RP4 — Viva or Supervisor Practice v3.2
...
# RP5 — Guided Topic Brainstorming v3.2
...
# SW2 — Tutor Feedback to Action Plan v3.2
