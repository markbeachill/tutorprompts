# AI Personal Tutor Toolkit — Step-by-Step Test Cards v2.3
...
```text
wt1_clarity_clinic_test_output_v1_9.md
wt1_clarity_clinic_audit_v1_9.md
```
...
- `01_writing_tutor_library_v1_9.md`
...
2. Upload `01_writing_tutor_library_v1_9.md`.
3. Type `prompt`.
...
```text
wt2_single_paragraph_analysis_test_output_v1_9.md
```
...
```text
wt2_single_paragraph_analysis_audit_v1_9.md
```
...
```text
wt3_find_my_mistakes_test_output_v1_9.md
```
...
```text
wt3_find_my_mistakes_audit_v1_9.md
```
...
```text
wt4_teach_me_this_mistake_test_output_v1_9.md
```
...
```text
wt4_teach_me_this_mistake_audit_v1_9.md
```
...
```text
wt5_style_and_clarity_review_test_output_v1_9.md
```
...
```text
wt5_style_and_clarity_review_audit_v1_9.md
```
...
```text
wt6_referencing_helper_test_output_v1_9.md
```
...
```text
wt6_referencing_helper_audit_v1_9.md
```
...
- `02_structure_tutor_library_v1_9.md`
- `ai_tutor_toolkit_audit_prompt_with_menu_v2_3.md`
- Somewhere to save Markdown files
...
1. Open a new AI chat.
2. Upload `02_structure_tutor_library_v1_9.md`.
3. Type `prompt`.
...
```text
st1_paragraph_structure_review_across_a_whole_draft_test_output_v1_9.md
```
...
```text
st1_paragraph_structure_review_across_a_whole_draft_audit_v1_9.md
```
...
```text
st2_wholework_structure_review_test_output_v1_9.md
```
...
```text
st2_wholework_structure_review_audit_v1_9.md
```
...
```text
st3_expert_meaning_review_test_output_v1_9.md
```
...
```text
st3_expert_meaning_review_audit_v1_9.md
```
...
- `03_academic_thinking_tutor_library_v1_9.md`
- `ai_tutor_toolkit_audit_prompt_with_menu_v2_3.md`
- Somewhere to save Markdown files
...
1. Open a new AI chat.
2. Upload `03_academic_thinking_tutor_library_v1_9.md`.
3. Type `prompt`.
...
```text
at1_assignment_brief_checker_test_output_v1_9.md
```
...
```text
at1_assignment_brief_checker_audit_v1_9.md
```
...
```text
at2_argument_map_test_output_v1_9.md
```
...
```text
at2_argument_map_audit_v1_9.md
```
...
```text
at3_descriptive_vs_analytical_check_test_output_v1_9.md
```
...
```text
at3_descriptive_vs_analytical_check_audit_v1_9.md
```
...
```text
at4_evidence_gap_checker_test_output_v1_9.md
```
...
```text
at4_evidence_gap_checker_audit_v1_9.md
```
...
```text
at5_concept_clarity_checker_test_output_v1_9.md
```
...
```text
at5_concept_clarity_checker_audit_v1_9.md
```
...
```text
at6_literature_use_checker_test_output_v1_9.md
```
...
```text
at6_literature_use_checker_audit_v1_9.md
```
...
```text
at7_counterargument_and_limitations_checker_test_output_v1_9.md
```
...
```text
at7_counterargument_and_limitations_checker_audit_v1_9.md
```
...
```text
at8_source_reliability_checker_test_output_v1_9.md
```
...
```text
at8_source_reliability_checker_audit_v1_9.md
```
...
```text
at9_critical_opponent_review_test_output_v1_9.md
```
...
```text
at9_critical_opponent_review_audit_v1_9.md
```
...
```text
at10_socratic_tutor_test_output_v1_9.md
```
...
```text
at10_socratic_tutor_audit_v1_9.md
```
...
- `04_research_proposal_tutor_library_v1_9.md`
- `ai_tutor_toolkit_audit_prompt_with_menu_v2_3.md`
- Somewhere to save Markdown files
...
1. Open a new AI chat.
2. Upload `04_research_proposal_tutor_library_v1_9.md`.
3. Type `prompt`.
...
```text
rp1_research_question_aim_and_objectives_checker_test_output_v1_9.md
```
...
```text
rp1_research_question_aim_and_objectives_checker_audit_v1_9.md
```
...
```text
rp2_methodology_fit_checker_test_output_v1_9.md
```
...
```text
rp2_methodology_fit_checker_audit_v1_9.md
```
...
```text
rp3_critical_research_supervisor_review_test_output_v1_9.md
```
...
```text
rp3_critical_research_supervisor_review_audit_v1_9.md
```
...
```text
rp4_viva_or_supervisor_practice_test_output_v1_9.md
```
...
```text
rp4_viva_or_supervisor_practice_audit_v1_9.md
```
...
```text
rp5_guided_topic_brainstorming_test_output_v1_9.md
```
...
```text
rp5_guided_topic_brainstorming_audit_v1_9.md
```
...
- `05_study_workflow_tutor_library_v1_9.md`
- `ai_tutor_toolkit_audit_prompt_with_menu_v2_3.md`
- Somewhere to save Markdown files
...
1. Open a new AI chat.
2. Upload `05_study_workflow_tutor_library_v1_9.md`.
3. Type `prompt`.
...
```text
sw1_revision_plan_test_output_v1_9.md
```
...
```text
sw1_revision_plan_audit_v1_9.md
```
...
```text
sw2_tutor_feedback_to_action_plan_test_output_v1_9.md
```
...
```text
sw2_tutor_feedback_to_action_plan_audit_v1_9.md
```
...
```text
sw3_aiuse_record_test_output_v1_9.md
```
...
```text
sw3_aiuse_record_audit_v1_9.md
```
