...
The current public prompt-library suite is v3.4.
...
Prompt libraries include a global rule that student challenges should be taken seriously. If a student corrects an AI interpretation, the tutor should re-read the text, acknowledge valid correction, revise its diagnosis, and avoid false certainty in specialist subject areas.
